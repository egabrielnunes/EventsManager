...
@WebServlet(urlPatterns={"/Layout"}, name="Layout")
...
public class Layout extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { //tela inicia pós login
		...
		out.println("<input type='submit' value='Usuarios'></form>");
		out.println("<form action='e' method='get'>");
		out.println("<input type='submit' value='Eventos'></form>");
		out.println("<form action='au' method='get'>");
		out.println("<input type='submit' value='Atualizar Conta'></form>");
		out.println("<form action='du' method='get'>");
		out.println("<input type='submit' value='Apagar Conta'></form>");
		out.println("<form action='Layout' method='post'>");
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException { //faz o logout
		...
		Usuario usuario = (Usuario) request.getSession(false).getAttribute("usuario"); //recupera sessao ativa
		if (usuario != null) {
			request.getSession(true).invalidate();//desativa a sessao
